...
export class CuriosityManager {
    ...
    async markGoalInProgress(runId) {
        ...
        return [
            {
                ...
                proposedAction: "Perform one bounded orientation pass over local workspace and OpenClaw state, identify a surprising or underexplored next clue, record what was learned, and stop before taking external action.",
